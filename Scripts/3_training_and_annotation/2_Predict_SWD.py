...
pred_data_path = '/Users/antoine/Documents/GitHub/EVD.COVID_ANALYSIS/EVD.COVID_ANALYSIS/Database/preprocessed_data/SWD.processed_conf_texts.csv'
...
pred = bert.predict_with_model(
    pred_loader,
    model_path='/Users/antoine/Documents/GitHub/EVD.COVID_ANALYSIS/EVD.COVID_ANALYSIS/models/detect_COVID_SWD'
)
...
evidence_pred = bert_evidence.predict_with_model(
    evidence_loader,
    model_path='/Users/antoine/Documents/GitHub/EVD.COVID_ANALYSIS/EVD.COVID_ANALYSIS/models/detect_evidence_SWD'
)
...
frame_pred = bert_frame.predict_with_model(
    frame_loader,
    model_path='/Users/antoine/Documents/GitHub/EVD.COVID_ANALYSIS/EVD.COVID_ANALYSIS/models/frame_SWD'
)
...
country_source_pred = bert_country_source.predict_with_model(
    ...
    model_path='/Users/antoine/Documents/GitHub/EVD.COVID_ANALYSIS/EVD.COVID_ANALYSIS/models/country_source_SWD'
)
...
frame_pred = bert_frame.predict_with_model(
    frame_loader,
    model_path='/Users/antoine/Documents/GitHub/EVD.COVID_ANALYSIS/EVD.COVID_ANALYSIS/models/measures_SWD'
)
...
frame_pred = bert_frame.predict_with_model(
    frame_loader,
    model_path='/Users/antoine/Documents/GitHub/EVD.COVID_ANALYSIS/EVD.COVID_ANALYSIS/models/detect_source_SWD'
)
...
frame_pred = bert_frame.predict_with_model(
    frame_loader,
    model_path='/Users/antoine/Documents/GitHub/EVD.COVID_ANALYSIS/EVD.COVID_ANALYSIS/models/journalist_question_SWD'
)
...
frame_pred = bert_frame.predict_with_model(
    frame_loader,
    model_path='/Users/antoine/Documents/GitHub/EVD.COVID_ANALYSIS/EVD.COVID_ANALYSIS/models/associated_emotion_SWD'
)
...
final_output_filepath = "/Users/antoine/Documents/GitHub/EVD.COVID_ANALYSIS/EVD.COVID_ANALYSIS/Database/annotated_data/SWD.final_annotated_texts.csv"
