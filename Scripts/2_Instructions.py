...
csv_path = os.path.join(script_dir, '..', 'Database', 'preprocessed_data', 'processed_conf_texts.csv')
...
instructions = {
    ...
    'country_source': "Examinez si la source scientifique mentionnée dans l'extrait provient d'un pays étranger au Canada. Indiquez 'Oui' ou 'Non' si la source provient d'un pays étranger. Si la source n'est pas clairement identifiée, indiquez 'NA'",
...
output_path = os.path.join(script_dir, '..', 'Database', 'preprocessed_data', 'instructions_conf_texts.csv')
