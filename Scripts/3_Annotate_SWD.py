...
for index, row in new_df.iterrows():
    ...
    if new_df.at[index, 'detect_COVID_response'] == 'oui':
        base_prompt = "Tu es un annotateur de texte en français. Commence ta réponse par l'une des options proposées."
